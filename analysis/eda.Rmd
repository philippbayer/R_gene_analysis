...
There are `nrow(nbs_joined)` NLR genes out of which `nbs_joined %>% filter(type == 'core') %>% nrow()` are core and `nbs_joined %>% filter(type == 'variable') %>% nrow()` are variable.
...
There are `nrow(rlk_joined)` RLK genes out of which `rlk_joined %>% filter(type == 'core') %>% nrow()` are core and `rlk_joined %>% filter(type == 'variable') %>% nrow()` are variable.
...
There are `nrow(rlp_joined)` RLK genes out of which `rlp_joined %>% filter(type == 'core') %>% nrow()` are core and `rlp_joined %>% filter(type == 'variable') %>% nrow()` are variable.
