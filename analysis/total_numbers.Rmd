...
```
There are `r nbsvar` variable genes in the NBS genes, and `r nbscore` core genes in the NBS genes.
...
```
There are `r rlpvar` variable genes in the RLP genes, and `r rlpcore` core genes in the RLP genes.
...
```
There are `r rlkvar` variable genes in the RLK genes, and `r rlkcore` core genes in the RLK genes.
